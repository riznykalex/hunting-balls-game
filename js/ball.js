...
export class Ball {
  ...
  update() {
    if (this.power < 1) {
      //  улька спить Ч не рухаЇтьс€ ≥ в≥дновлюЇ енерг≥ю
      this.isMoving = false;
      this.vx = 0;
      this.vy = 0;
      ...
      //  улька рухаЇтьс€ Ч втрачаЇ енерг≥ю
      this.move(this.vx, this.vy);

      let distMoved = Math.hypot(this.vx, this.vy);
      this.power -= distMoved * 0.003; // можна налаштувати коеф≥ц≥Їнт
      ...
      //  улька не рухаЇтьс€ Ч пов≥льно в≥дновлюЇ енерг≥ю
      this.power += 0.001;
